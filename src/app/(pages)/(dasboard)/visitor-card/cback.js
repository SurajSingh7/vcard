              ...
              <div className="mt-4 flex justify-center">
                {!capturedFront ? (
                  <button
                    ...
                    className={`${
                      !isFrontVideoReady ? "bg-gray-400 cursor-not-allowed" : "bg-orange-500 hover:bg-orange-600"
                    } text-white font-semibold px-6 py-3 rounded-lg shadow transition-all focus:ring-2 focus:ring-orange-500 focus:outline-none`}
                  >
                    <div className="flex items-center space-x-2">
                      <Camera size={18} />
                      <span>{isFrontVideoReady ? "Capture Front" : "Loading..."}</span>
                    </div>
                  </button>
                ) : (
                  <button
              ...
              <div className="mt-4 flex justify-center">
                {!capturedBack ? (
                  <button
                    ...
                    className={`${
                      !isBackVideoReady ? "bg-gray-400 cursor-not-allowed" : "bg-orange-500 hover:bg-orange-600"
                    } text-white font-semibold px-6 py-3 rounded-lg shadow transition-all focus:ring-2 focus:ring-orange-500 focus:outline-none`}
                  >
                    <div className="flex items-center space-x-2">
                      <Camera size={18} />
                      <span>{isBackVideoReady ? "Capture Back" : "Loading..."}</span>
                    </div>
                  </button>
                ) : (
                  <button
